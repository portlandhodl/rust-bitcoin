...
impl Xpriv {
    ...
    pub fn new_master(network: impl Into<NetworkKind>, seed: &[u8]) -> Result<Xpriv, Error> {
        ...
        Ok(Xpriv {
            ...
            private_key: secp256k1::SecretKey::from_secret_bytes(hmac_result[..32].try_into().expect("32 bytes"))?,
    ...
    pub fn to_keypair<C: secp256k1::Signing>(self, secp: &Secp256k1<C>) -> Keypair {
        Keypair::from_seckey_byte_array(self.private_key[..32].try_into().expect("32 bytes"))
    ...
    fn ckd_priv<C: secp256k1::Signing>(
        ...
        let hmac_result: Hmac<sha512::Hash> = Hmac::from_engine(hmac_engine);
        let sk = secp256k1::SecretKey::from_secret_bytes(hmac_result[..32].try_into().expect("32 bytes"))
    ...
    pub fn decode(data: &[u8]) -> Result<Xpriv, Error> {
        ...
        Ok(Xpriv {
            ...
            private_key: secp256k1::SecretKey::from_secret_bytes(data[46..78].try_into().expect("32 bytes"))?,
        })
    }
    ...
    pub fn ckd_pub_tweak(
        ...
        match i {
            ...
            ChildNumber::Normal { index: n } => {
                ...
                let private_key = secp256k1::SecretKey::from_secret_bytes(hmac_result[..32].try_into().expect("32 bytes"))?;
